...
- Add JsMin: Compile Now and JsMin: Beautify Now to the Extensions menu. Both target the current local file and work with Run on Save disabled. Beautify Now formats the source in place and preserves comments without compression or mangling.
